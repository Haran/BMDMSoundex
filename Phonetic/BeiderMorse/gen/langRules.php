...
$this->langRules = array(
 ...
 // array("/لا/‎", $this->lang['arabic'], true), // ligature l+a
    ...
    array("/y/", $this->lang['cyrillic'] + $this->lang['hebrew'] + $this->lang['greek'] + $this->lang['arabic'] + $this->lang['romanian'] + $this->lang['dutch'], false),
    ...
    array("/q/", $this->lang['hungarian'] + $this->lang['polish'] + $this->lang['russian'] + $this->lang['romanian'] + $this->lang['czech'] + $this->lang['dutch'] + $this->lang['turkish'] + $this->lang['greeklatin'], false),
    array("/v/", $this->lang['polish'], false),
    array("/w/", $this->lang['french'] + $this->lang['romanian'] + $this->lang['spanish'] + $this->lang['hungarian'] + $this->lang['russian'] + $this->lang['czech'] + $this->lang['turkish'] + $this->lang['greeklatin'], false),
    array("/x/", $this->lang['czech'] + $this->lang['hungarian'] + $this->lang['dutch'] + $this->lang['turkish'], false), // polish excluded from the list
